      ...
      const monthlyPipeline = [
        ...
        },
        {
            $project: {
                ...
                total_cost: {
                    $add: [
                        { $multiply: [ { $divide: ["$total_prompt_tokens", 1000] }, ctx.env.ai_llm_1k_token_costs_input ] },
                        { $multiply: [ { $divide: ["$total_completion_tokens", 1000] }, ctx.env.ai_llm_1k_token_costs_output ] }
                    ]
                },
