...
// Build reverse translation map for normalizing incoming translated values (e.g., pump status from AAPS)
language.buildReverseTranslationMap(fs, path, ['Normal', 'Suspended', 'Bolusing']);
