...
function init (env, ctx, server) {
  ...
  function snapshotForDelta () {
    return {
      sgvs: _.cloneDeep(ctx.ddata.sgvs || [])
      , treatments: _.cloneDeep(ctx.ddata.treatments || [])
      , mbgs: _.cloneDeep(ctx.ddata.mbgs || [])
      , cals: _.cloneDeep(ctx.ddata.cals || [])
      , devicestatus: _.cloneDeep(ctx.ddata.devicestatus || [])
      , profiles: _.cloneDeep(ctx.ddata.profiles || [])
