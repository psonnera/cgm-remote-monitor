...
function config () {
  ...
  env.ai_llm_1k_token_costs_input = parseFloat(readENV('AI_LLM_1K_TOKEN_COSTS_INPUT', 0.005));
  env.ai_llm_1k_token_costs_output = parseFloat(readENV('AI_LLM_1K_TOKEN_COSTS_OUTPUT', 0.015));
