  ...
  chart.update = function update (init) {
    ...
    if (widthChanged || (chart.prevChartHeight !== chartHeight)) {
      ...
      if (init) {
        ...
        // Make the drag-sensitive area only at the very bottom of the chart, below all graph content
        var dragStartY = chartHeight + PADDING_BOTTOM - 10; // 10px above the bottom for safety
        ...
        // Attach drag behavior only to the very bottom overlay
    ...
    // Restrict drag overlay to only the very bottom of the chart
    var dragStartY = (chart.prevChartHeight || chartHeight) + PADDING_BOTTOM - 10;
    chart.dragOverlay
      .attr('x', 0)
      .attr('y', dragStartY)
