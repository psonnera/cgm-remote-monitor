...
function init (client, d3, $) {
  ...
  chart.update = function update (init) {
    ...
    var focusHeight = chart.focusHeight = chartHeight * .59;
    var focusBottomMargin = chartHeight * .05; // 5% free space below focus
    var basalsHeight = chart.basalsHeight = chartHeight * .20;
    var contextHeight = chart.contextHeight = chartHeight * .12;
    var contextTopMargin = chartHeight * .02; // 2% free space above context
