  ...
  client.init(function loaded () {
    ...
    function show (event) {
      ...
      function display () {
        var count = 0;
        sorteddaystoshow = [];
        $('#info').html('<b>' + translate('Loading data') + '...</b><br><div id="progress-container" style="width: 100%; background-color: #f0f0f0; border: 1px solid #ccc; border-radius: 5px; margin-top: 10px; height: 30px;"><div id="progress-bar" style="width: 0%; height: 100%; background-color: #6c6; border-radius: 5px; transition: width 0.3s ease; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold;"><span id="progress-text">0%</span></div></div>');
