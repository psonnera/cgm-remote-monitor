  ...
  weektoweek.report = function report_weektoweek (datastorage, sorteddaystoshow, options) {
    ...
    function drawChart (week, sgvData, options) {
      ...
      if (bgValues.length > 0) {
        ...
        // Range table
        glucoseStatsHtml += '<table class="weektoweek-rangetable"><tbody>';
        ...
        glucoseStatsHtml += '<table class="weektoweek-statstable"><thead><tr><th colspan="2">' + translate('Statistics') + '</th></tr></thead><tbody>';
