...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  var rangeDefinitions = [
    {name: 'Very High', label: 'Very High', range: '>250', target1: '<5%', target2: '<25%', target2Rowspan: 2, targetValue: 5, comparison: '<'},
    {name: 'High', label: 'High', range: '181-250', target1: '', target2Skip: true, targetValue: 25, comparison: '<'},
    {name: 'Target Range', label: 'TIR', range: '70-180', target1: '≥70%', target2: '', targetValue: 70, comparison: '>='},
    {name: 'TITR', label: 'TITR', range: '70-140', target1: '≥50%', target2: '', targetValue: 50, comparison: '>='},
    {name: 'Low', label: 'Low', range: '54-69', target1: '', target2: '<4%', target2Rowspan: 2, targetValue: 4, comparison: '<'},
  ...
  var avgValue, stdValue, stdBgColor, gmiValue, gmiBgColor, gmiDisplay;
  ...
  if (glucose_data.length > 0) {
    ...
    $('<tr><td class="tdborder"><strong>' + translate('STD') + '</strong></td><td class="tdborder" style="' + stdBgColor + '">' + stdValue.toFixed(1) + '</td></tr>').appendTo(statsTable);
