...
glucosedistribution.report = function report_glucosedistribution (datastorage, sorteddaystoshow, options) {
  ...
  setTimeout(function() {
    processGlucoseDistribution(datastorage, sorteddaystoshow, options, ss, translate, displayUnits);
  }, 0);
};

function processGlucoseDistribution(datastorage, sorteddaystoshow, options, ss, translate, displayUnits) {
