...
daytoday.html = function html (client) {
  ...
  var ret =
    ...
    '&nbsp;' + translate('Size') +
    ' <select id="rp_size">' +
    '  <option x="800" y="250" selected>800x250px</option>' +
...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  function drawChart (day, data, options) {
    ...
    if (bgValues.length > 0) {
      ...
      // Render glucose stats to middle column
      var glucoseStatsHtml = '<div style="text-align: center; margin-bottom: 10px;">';
      
      // Range table
      glucoseStatsHtml += '<table class="daytoday-rangetable"><tbody>';
      ...
      // Statistics table
      glucoseStatsHtml += '<table class="daytoday-statstable"><thead><tr><th colspan="2">' + translate('Statistics') + '</th></tr></thead><tbody>';
    ...
    if (options.insulindistribution) {
      ...
      $('<tr><td><b>' + translate('Total basal insulin:') + '</b></td><td align="right">' + baseBasalInsulin.toFixed(1) + 'U</td></tr>').appendTo(table);
