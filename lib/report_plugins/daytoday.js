...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  function drawChart (day, data, options) {
    ...
    if (options.insulindistribution) {
      ...
      $('<tr><td><b>' + translate('Total bolus insulin:') + '</b></td><td align="right">' + bolusInsulin.toFixed(1) + 'U</td></tr>').appendTo(table);
      ...
      $('<tr><td><b>' + translate('Total daily carbs:') + '</b></td><td align="right">' + data.dailyCarbs + ' g</td></tr>').appendTo(table);
