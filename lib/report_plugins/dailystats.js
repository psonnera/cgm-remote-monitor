...
dailystats.css =
  ...
  '  height: 0.9in;' +
  '}' +
  '#dailystats-placeholder .dailystats-bar {' +
  '  width: 1.1in;' +
  '  height: 0.9in;' +
  ...
  '}' +
  '#dailystats-placeholder .dailystats-segment {' +
  '  width: 100%;' +
  '  display: flex;' +
  '  align-items: center;' +
  ...
  '  color: #333;' +
  '}' +
  '#dailystats-placeholder .dailystats-segment span {' +
  '  display: block;' +
  '  padding: 0 2px;' +
  '}';
...
dailystats.report = function report_dailystats (datastorage, sorteddaystoshow, options) {
  ...
  // Modernized: Async chunked day rendering for better UI responsiveness
  var dayIdx = 0;
  var chunkSize = 5; // Process 5 days at a time
  ...
  function processDayStats(day) {
    ...
    var stdValue = ss.standardDeviation(bgValues);
    var stdColor = '';
    ...
    var barHtml = '<div class="dailystats-bar">' +
      '<div class="dailystats-segment" style="height:' + lowPct + '%; background-color:#f88;">' + lowLabel + '</div>' +
      '<div class="dailystats-segment" style="height:' + normalPct + '%; background-color:#8f8;">' + normalLabel + '</div>' +
      '<div class="dailystats-segment" style="height:' + highPct + '%; background-color:#ff8; color:#000;">' + highLabel + '</div>' +
      '</div>';
    $('#dailystat-chart-' + day.toString()).html(barHtml);
  }
